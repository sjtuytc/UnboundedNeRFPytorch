...
def title_by_cls(cls_str, cn):
    if not cn:
        ...
        "## 按类别筛选: [全部](../weekly_nerf.md) | [动态](./dynamic.md) | [编辑](./editing.md) | [快速](./fast.md) | [泛化](./generalization.md) \n"
        cls_head2 = "## [光照](./lighting.md) | [重建](./reconstruction.md) | [纹理](./texture.md) | [语义](./semantic.md) | [姿态-SLAM](./pose-slam.md) | [其他](./others.md) \n"
        cls_en_to_cn = {'lighting':"光照",	'editing':"编辑", 'fast':"快速",	'dynamic':"动态",	'generalization':"泛化", 'reconstruction':"重建",	'pose-slam':"姿态-SLAM", 'texture':"纹理",	'semantic':"语义",	'others':"其他"}
...
def render_main_doc(meta_data_path="docs/weekly_nerf_meta_data.xlsx", cn=False):
    ...
    classes = ['lighting',	'editing', 'fast',	'dynamic',	'generalization', 'reconstruction',	'pose-slam', 'texture',	'semantic',	'others']
    ...
    if not cn:
        ...
        cls_head = "## Filter by classes: [all](./weekly_nerf.md) | [dynamic](./classified_weekly_nerf/dynamic.md) | [editing](./classified_weekly_nerf/editing.md) | [fast](./classified_weekly_nerf/fast.md) | [generalization](./classified_weekly_nerf/generalization.md) \n"
        ...
        cls_head = "## 按类别筛选: [全部](./weekly_nerf_cn.md) | [动态](./classified_weekly_nerf_cn/dynamic.md) | [编辑](./classified_weekly_nerf_cn/editing.md) | [快速](./classified_weekly_nerf_cn/fast.md) | [泛化](./classified_weekly_nerf_cn/generalization.md) \n"
    ...
    # note this is different from above
    if not cn:
        cls_head = "## Filter by classes: [all](../weekly_nerf.md) | [dynamic](./dynamic.md) | [editing](./editing.md) | [fast](./fast.md) | [generalization](./generalization.md) \n"
        ...
        cls_head = "## 按类别筛选: [全部](../weekly_nerf_cn.md) | [动态](./dynamic.md) | [编辑](./editing.md) | [快速](./fast.md) | [泛化](./generalization.md) \n"
        cls_head2 = "## [光照](./lighting.md) | [重建](./reconstruction.md) | [纹理](./texture.md) | [语义](./semantic.md) | [姿态-SLAM](./pose-slam.md) | [其他](./others.md) \n"
    for cls in cls_md:
