...
# visualize cameras
CUDA_VISIBLE_DEVICES=8 python run_yono.py --program export_bbox --config ${CONFIG} --export_bbox_and_cams_only data/sep26_2/cam.npz --sample_num 100
# visualize geometry
CUDA_VISIBLE_DEVICES=3 python run_yono.py --program export_coarse --config ${CONFIG} --export_coarse_only data/sep26_2/cam_coarse.npz --sample_num 100
