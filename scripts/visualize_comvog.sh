# export CONFIG=comvog/configs/tankstemple_unbounded/Playground.py #comvog/configs/waymo/block_0_tt.py
export CONFIG=comvog/configs/waymo/waymo_full.py
# visualize cameras
CUDA_VISIBLE_DEVICES=8 python run_comvog.py --program export_bbox --config ${CONFIG} --export_bbox_and_cams_only data/sep26_2/cam.npz --sample_num 100
# visualize geometry
