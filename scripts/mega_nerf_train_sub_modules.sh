...
python train_mega_nerf.py --config_file configs/mega-nerf/${DATASET_NAME}.yaml --exp_name ${EXP_FOLDER}/${SUBMODULE_INDEX} --dataset_path $DATASET_PATH --chunk_paths data/mega/${DATASET_NAME}/chunks/${SUBMODULE_INDEX} --cluster_mask_path ${MASK_PATH}/${SUBMODULE_INDEX}
