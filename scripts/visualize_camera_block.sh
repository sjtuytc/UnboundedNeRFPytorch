...
# visualize cameras
CUDA_VISIBLE_DEVICES=8 python run_yono.py --program export_bbox --config ${CONFIG} --export_bbox_and_cams_only data/tanks_vis/cam.npz
# visualize geometry
CUDA_VISIBLE_DEVICES=3 python run_yono.py --program export_coarse --config ${CONFIG} --export_coarse_only data/tanks_vis/cam_coarse.npz
